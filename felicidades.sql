...
INSERT INTO tb_ocorrencia(id_tipo_ocorrencia_fk,id_pessoa_fk,id_sub_lugar_fk,ocorrencia_descricao,ocorrencia_data,ocorrencia_data_registro,ocorrencia_status) VALUES
	(2,1,1,'Sofri assédio de um colega meu no bloco 1, ele não é mais meu amigo','2023-05-01','2023-01-06',true),
    (3,2,21,'Um colega meu desapareceu depois que o vi assediar uma pessoa','2023-05-01','2023-01-06',false),
    (2,2,41,'Presenciei um comportamento inadequado no bloco 2, onde um colega estava fazendo comentários inapropriados.','2023-05-01','2023-01-06',false),
    (1,2,61,'Registrei um acidente de trânsito próximo ao estacionamento principal.','2023-01-01','2023-12-06',false),
    (1,2,81,'Presenciei uma colisão entre veículos na entrada da universidade.','2023-05-01','2023-02-06',false),
    ...
    (4,2,181,'Registro de um caso de extravio de pertences no corredor do bloco 3.','2023-05-01','2023-05-06',true),
    (4,2,201,'Estudante comunica extravio de documento na área de convivência; auxílio na busca solicitado.','2023-05-01','2023-05-06',false),
    (5,2,221,'Identificamos uma suspeita de fraude em transações financeiras.','2023-05-01','2023-12-06',false),
    (5,2,241,'Foi relatado o uso indevido de recursos em um departamento acadêmico.','2023-05-01','2023-03-06',false),
    (5,2,261,'Estudante relata uso não autorizado de sua conta em serviços online; investigação solicitada.','2023-05-01','2023-03-06',false),
    (5,2,281,'Identificada falsificação de documentos para obtenção de benefícios estudantis; ação disciplinar requerida.','2023-05-01','2023-05-06',false),
    (5,2,301,'Fraude em cartões de acesso ao laboratório de química; reforçar medidas de segurança.','2023-05-01','2023-12-06',true),
    ...
    (6,2,21,'Um aluno relatou o desaparecimento de pertences pessoais na área esportiva.','2023-05-01','2023-12-06',false),
    (6,2,7,'Equipamentos esportivos furtados do depósito do ginásio; reforçar segurança na área.','2023-05-01','2023-04-06',false),
    (6,2,23,'Furto de materiais de construção no canteiro próximo ao bloco 8; investigação solicitada.','2023-05-01','2023-05-06',false),
    (6,2,103,'Estudante relata furto de bicicleta no bicicletário; reforçar sistema de vigilância.','2023-05-01','2023-09-06',true),
    ...
    (7,2,19,'Um estudante se machucou durante uma atividade extracurricular jogando bola.','2023-05-01','2023-04-06',false),
    (7,2,83,'Estudante com contusão após queda nas escadas do bloco 4; encaminhamento à enfermaria.','2023-05-01','2023-07-06',false),
    (7,2,113,'Lesão durante atividade de laboratório no bloco 2; necessidade de kit de primeiros socorros.','2023-05-01','2023-09-06',false),
    ...
    (7,2,12,'Lesão corporal leve em incidente durante evento acadêmico no auditório; assistência médica necessária.','2023-05-01','2023-05-06',false),
    (7,2,93,'Estudante ferido durante prática esportiva no ginásio; equipe médica solicitada.','2023-05-01','2023-08-06',false),
    (7,2,293,'Estudante sofre lesão durante atividade esportiva no campo de futebol; atendimento médico imediato.','2023-05-01','2023-10-06',false),
