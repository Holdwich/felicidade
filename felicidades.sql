...
INSERT INTO tb_ocorrencia(id_tipo_ocorrencia_fk,id_pessoa_fk,id_sub_lugar_fk,ocorrencia_descricao,ocorrencia_data,ocorrencia_data_registro,ocorrencia_status) VALUES
    (2,1,1,'Sofri assedio de um colega meu no bloco 1, ele nao e mais meu amigo','2023-05-01','2023-01-06',true),
    (3,1,21,'Um colega meu desapareceu depois que vi ele assediar uma pessoa','2023-05-01','2023-01-06',false),
    (2,1,41,'Presenciei um comportamento inadequado no bloco 2, onde um colega estava fazendo comentários inapropriados.','2023-05-01','2023-01-06',false),
    (1,1,61,'Registrei um acidente de trânsito próximo ao estacionamento principal.','2023-01-01','2023-12-06',false),
    (1,1,81,'Presenciei uma colisão entre veículos na entrada da universidade.','2023-05-01','2023-02-06',false),
    (3,2,101,'Houve um relato de uma pessoa desaparecida na área do campus.','2023-05-01','2023-02-06',false),
    (3,2,121,'Recebi informações sobre um estudante que está desaparecido desde ontem.','2023-05-01','2023-02-06',false),
    (3,2,141,'Relato de desaparecimento de visitante durante evento no auditório; cooperação com autoridades necessária.','2023-02-01','2023-12-06',false),
    (4,2,161,'Um estudante perdeu seu material didático na biblioteca; favor verificar.','2023-05-01','2023-03-06',false),
    (4,1,181,'Registro de um caso de extravio de pertences no corredor do bloco 3.','2023-05-01','2023-05-06',true),
    (4,1,201,'Estudante comunica extravio de documento na área de convivência; auxílio na busca solicitado.','2023-05-01','2023-05-06',false),
    (5,2,221,'Identificamos uma suspeita de fraude em transações financeiras.','2023-05-01','2023-12-06',false),
    (5,3,241,'Foi relatado o uso indevido de recursos em um departamento acadêmico.','2023-05-01','2023-03-06',false),
    (5,3,261,'Estudante relata uso não autorizado de sua conta em serviços online; investigação solicitada.','2023-05-01','2023-03-06',false),
    (5,3,281,'Identificada falsificação de documentos para obtenção de benefícios estudantis; ação disciplinar requerida.','2023-05-01','2023-05-06',false),
    (5,3,301,'Fraude em cartões de acesso ao laboratório de química; reforçar medidas de segurança.','2023-05-01','2023-12-06',true),
    (5,2,321,'Relato de apropriação indevida de materiais de laboratório; investigação em andamento.','2023-05-01','2023-04-06',false),
    (5,2,328,'Suspeita de fraude em transações financeiras do centro acadêmico; auditoria solicitada.','2023-05-01','2023-04-06',false),
    (6,2,22,'Recebi um alerta sobre furtos de laptops na sala de estudos.','2023-05-01','2023-09-06',false),
    (6,4,21,'Um aluno relatou o desaparecimento de pertences pessoais na área esportiva.','2023-05-01','2023-12-06',false),
    (6,5,7,'Equipamentos esportivos furtados do depósito do ginásio; reforçar segurança na área.','2023-05-01','2023-04-06',false),
    (6,6,23,'Furto de materiais de construção no canteiro próximo ao bloco 8; investigação solicitada.','2023-05-01','2023-05-06',false),
    (6,7,103,'Estudante relata furto de bicicleta no bicicletário; reforçar sistema de vigilância.','2023-05-01','2023-09-06',true),
    (6,2,29,'Objetos pessoais furtados no vestiário do bloco 3; investigação em andamento.','2023-05-01','2023-11-06',false),
    (6,2,5,'Relato de furto de laptops na biblioteca durante o horário de pico; reforçar segurança.','2023-05-01','2023-04-06',false),
    (6,2,73,'Biblioteca do bloco 5 registra novo caso de furto de livros raros; reforçar segurança no acervo.','2023-05-01','2023-06-06',false),
    (6,2,143,'Furto de equipamentos esportivos em área externa próxima ao campo; intensificar monitoramento.','2023-05-01','2023-09-06',false),
    (7,2,76,'Ocorreu um incidente esportivo na aula de basquete resultando em lesões.','2023-05-01','2023-01-06',false), 
    (7,7,19,'Um estudante se machucou durante uma atividade extracurricular jogando bola.','2023-05-01','2023-04-06',false),
    (7,8,83,'Estudante com contusão após queda nas escadas do bloco 4; encaminhamento à enfermaria.','2023-05-01','2023-07-06',false),
    (7,9,113,'Lesão durante atividade de laboratório no bloco 2; necessidade de kit de primeiros socorros.','2023-05-01','2023-09-06',false),
    (7,2,102,'Aluno machucado em acidente envolvendo bicicletas próximo ao bloco 6; atendimento médico urgente.','2023-05-01','2023-02-06',false),
    (7,1,12,'Lesão corporal leve em incidente durante evento acadêmico no auditório; assistência médica necessária.','2023-05-01','2023-05-06',false),
    (7,1,93,'Estudante ferido durante prática esportiva no ginásio; equipe médica solicitada.','2023-05-01','2023-08-06',false),
    (7,1,293,'Estudante sofre lesão durante atividade esportiva no campo de futebol; atendimento médico imediato.','2023-05-01','2023-10-06',false),
    (8,2,223,'Relato de uma briga entre estudantes no campo esportivo.','2023-05-01','2023-04-06',false),
    (8,2,65,'Estudante se sente ameaçado por outro colega; intervenção necessária.','2023-05-01','2023-05-06',false),
    (8,2,33,'Alunos envolvidos em conflito verbal no refeitório; intervenção imediata requerida.','2023-05-01','2023-08-06',true),
    (8,2,123,'Estudantes relatam ameaças verbais em área de convivência no bloco 3; ação preventiva necessária.','2023-05-01','2023-10-06',false),
    (8,2,213,'Briga entre grupos estudantis no campo esportivo; segurança solicitada.','2023-05-01','2023-03-06',false),
    (8,2,94,'Ameaças entre colegas de classe na sala 104 do bloco 5; intervenção do conselho estudantil necessária.','2023-05-01','2023-06-06',false),
    (8,2,33,'Discussão acalorada entre estudantes no estacionamento principal; segurança alertada.','2023-05-01','2023-08-06',false),
    (8,2,23,'Relato de ameaça física entre alunos do curso de psicologia; aconselhamento requerido.','2023-05-01','2023-10-06',false),
    (9,2,323,'Equipamentos do laboratório de informática precisam de manutenção urgente.','2023-05-01','2023-05-06',false),
    (9,2,83,'Sala de aula com problemas nos projetores; solicitação de reparo.','2023-05-01','2023-06-06',false),
    (9,2,43,'Relatado vandalismo na sala de professores no bloco 5; urgencia em reparos.','2023-05-01','2023-07-06',false),
    (9,2,223,'Identificados danos estruturais na entrada do auditório; intervencao necessária.','2023-05-01','2023-10-06',true),
    (9,2,232,'Estudantes alertam sobre problemas elétricos na biblioteca; manutencao solicitada.','2023-05-01','2023-07-06',false),
    (9,2,73,'Registro de incidente de quebra de vidraça na cantina; reparo imediato necessário.','2023-05-01','2023-07-06',false),
    (9,2,43,'Sala de aula no bloco 2 apresenta vazamento; manutencao preventiva requerida.','2023-05-01','2023-07-06',false),
    (9,2,213,'Ocorrência de pichação nas paredes externas do bloco 4; limpeza solicitada.','2023-05-01','2023-10-06',false),
    (9,2,236,'Danos no sistema de ventilacao da sala de ciencias; manutencao urgente necessária.','2023-05-01','2023-08-06',false),
    (9,2,63,'Identificados problemas hidraulicos nos banheiros do bloco 3; reparos solicitados.','2023-05-01','2023-07-06',false),
    (10,2,53,'Identificados danos em uma das salas de aula; reparos necessarios.','2023-05-01','2023-07-06',false),
    (10,2,233,'Relato de vandalismo no banheiro do bloco 2; acao preventiva requerida.','2023-05-01','2023-11-06',false),
    (10,2,273,'Identificados danos estruturais na sala de aula 106 do bloco 3; avaliação técnica e reparo solicitados.','2023-05-01','2023-05-06',false),
    (11,2,63,'Alunos reclamaram sobre problemas de iluminação na área do estacionamento.','2023-05-01','2023-08-06',false),
    (12,2,243,'Relato de vazamento de água no corredor do bloco 4; manutenção necessária.','2023-05-01','2023-09-06',false),
    (12,2,319,'Aluno relata avistamento de animal exótico no campus.','2023-05-01','2023-11-06',false);
